    ...
    while ((c = fgetc(input)) != EOF) {
        if (isalpha(c) != 0) {
            ...
            if (plane_num <= 10) {
                ...
                strcpy(evening[plane_num - 10].passenger[all], file_pass);
                strcpy(evening[plane_num - 10].passport[all], file_port);
            }
            for (char &file_pas: file_pass) {
                file_pas = '\0';
            }
        ...
        for(int i=1;i<=20;i++)
        {
            ...
            for(int j=1;j<=50;j++)
            {
                ...
                else
                {
                    if(j%5==0)
                    {
                        if(strcmp(evening[i - 10].passenger[j],"empty")==0)
                            fprintf(input,"empty\n");
                        else
                            fprintf(input,"%s%s\n",evening[i - 10].passenger[j],evening[i - 10].passport[j]);
                    }
                    else
                    {
                        if(strcmp(evening[i - 10].passenger[j],"empty")==0)
                            ...
                            fprintf(input,"%s%s ",evening[i - 10].passenger[j],evening[i - 10].passport[j]);
                    }
                }
            }
            b++;
    ...
    while(choice!=5)
    {
        switch(choice)
        {
                ...
                if(mor_evening==1)
                {
                    while(true)
                    {
                        if(strcmp(morning[x].passenger[reserve_seat],"empty")==0)
                        {
                            ...
                            strcpy(morning[x].passport[reserve_seat], port);
                            cout << "Reserve successful" << endl;
                        }
                        else
                        {
                            cout << "We apologist, this seat has been reserved." << endl;
                        }
                        ...
                        if(new_seat==1)
                        {
                            cout << "Enter the number of new seat that you want to reserve";
                            cin >> reserve_seat;
                        }
                ...
                else
                {
                    while(true)
                    {
                        if(strcmp(evening[x].passenger[reserve_seat],"empty")==0)
                        {
                            ...
                            strcpy(evening[x].passport[reserve_seat], port);
                            cout << "Reserve successful" << endl;
            ...
            case 3:
                ...
                cout << "Enter \n1: if u reserve morning \n2: if u reserve evening:" << endl;
                cin >> set;
                while(set != 1 && set!=2)
                {
                    cout << "You enter an invalid number.Try again!" << endl;
                ...
                if(set==1)
                {
                    cout << "Name:\t " << morning[flightnum].passenger[seatnum]<< endl;
                    cout << "ID card number: \t" << morning[flightnum].passport[seatnum]<< endl;
                }
                else
                {
                    cout << "Name:\t " << evening[flightnum].passenger[seatnum] << endl;
                    cout << "ID card number: \t" << evening[flightnum].passport[seatnum]<< endl;
                }
                cout << "Departure Time: \t"<<departure_time(flightnum,set);
